...
type FootballPlayerPageRepo = {
    tournaments: TournamentDetails[]
    player: PlayerDetails
    events: EventDetails[]
}

type FootballPlayerPageProps = InferGetServerSidePropsType<typeof getServerSideProps>
...
const FootballPlayerPage: NextPageWithLayout<FootballPlayerPageProps> = ({ repo }) => {
    const t = useTranslations('FootballPlayerPage')
            ...
            <Box ml={[0, 24]} mr={[0, 24]} mb={24}>
                ...
                <Flex flexDirection={['column', 'row']} gap={24} w="100%" alignItems="flex-start">
                    ...
                    <Flex
                        ...
                        gap={[0, 12]}
                    >
                        <PlayerHeader player={repo.player} sport="football" w="100%" borderRadius={[0, 16]} />
                        <Flex
                            w="100%"
                            ml={[8, 0]}
                            mr={[8, 0]}
...
FootballPlayerPage.getLayout = function getLayout(page: ReactElement) {
...
}) satisfies GetServerSideProps<{ repo: FootballPlayerPageRepo }>
